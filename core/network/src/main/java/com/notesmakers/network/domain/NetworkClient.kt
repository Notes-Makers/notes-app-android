...
interface NetworkClient {
    ...
    suspend fun deleteItem(noteId: String, pageId: String, itemId: String): ApolloResponse<DeleteItemMutation.Data>
    ...
    suspend fun getItem(noteId: String, pageId: String, itemId: String): ApolloResponse<GetItemQuery.Data>
